      ...
      <div class="row-fluid">
        <div class="span12 widget-span widget-type-cell " style="" data-widget-type="cell" data-x="0" data-w="12">
                  ...
                  <div class="slider glide slider--dnd_area-module-1 glide--ltr glide--carousel glide--swipeable" id="">
                    <div class="glide__track" data-glide-el="track">
                      <ul class="glide__slides" style="transition: transform cubic-bezier(0.165, 0.84, 0.44, 1); width: 3825px; transform: translate3d(-1275px, 0px, 0px);">
                        <li class="glide__slide lazy glide__slide--clone" style="background-position: center center; width: 1275px; margin-right: 0px;" data-bg="<?php echo url('assets/img/inspector-jobs-1-1.webp?width=2100&amp;name=inspector-jobs-1-1.webp'); ?>">
                        ...
                        <li class="glide__slide lazy glide__slide--active loaded" style="background-position: center center; width: 1275px; margin-left: 0px; margin-right: 0px; background-image: url('<?php echo url('assets/img/inspector-jobs-1-1.webp?width=2100&amp;name=inspector-jobs-1-1.webp'); ?>');" data-ll-status="loaded">
                          <div class="slider__inner-container">
                            <div class="slider__inner ">
                              <h1 style="font-size: 43px; text-align: left; line-height: 1.15;">
                                <strong>World's quickest <br>inspection marketplace! </strong>
                        ...
                        <li class="glide__slide lazy glide__slide--clone" style="background-position: center center; width: 1275px; margin-left: 0px;" data-bg="<?php echo url('assets/img/inspector-jobs-1-1.webp?width=2100&amp;name=inspector-jobs-1-1.webp'); ?>">
                          <div class="slider__inner-container">
                            <div class="slider__inner ">
                              <h1 style="font-size: 43px; text-align: left; line-height: 1.15;">
                                <strong>World's quickest <br>inspection marketplace! </strong>
          ...
          <div class="row-fluid-wrapper row-depth-1 row-number-14 dnd-section dnd_area-row-3-padding dnd_area-row-3-vertical-alignment">
            <div class="row-fluid ">
              <div class="span6 widget-span widget-type-cell cell_16606602462482-vertical-alignment dnd-column aos-init" style="" data-widget-type="cell" data-x="0" data-w="6" data-aos="fade-up" data-aos-delay="0">
                <div class="row-fluid-wrapper row-depth-1 row-number-15 dnd-row">
                  <div class="row-fluid ">
                    <div class="span12 widget-span widget-type-custom_widget widget_1660660245919-flexbox-positioning dnd-module" style="" data-widget-type="custom_widget" data-x="0" data-w="12">
                      <div id="hs_cos_wrapper_widget_1660660245919" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module widget-type-linked_image" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module">
                        <span id="hs_cos_wrapper_widget_1660660245919_" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_linked_image" style="" data-hs-cos-general-type="widget" data-hs-cos-type="linked_image">
                          <img src="{{ url('assets/img/AppLookMobile2v.png?width=383&height=600&name=AppLookMobile2v.png') }}" class="hs-image-widget " width="383" height="600" style="max-width: 100%; height: auto;" alt="AppLookMobile2v" title="AppLookMobile2v" loading="lazy" srcset="
                          {{ url('assets/img/AppLookMobile2v192x300.png?width=192&height=300&name=AppLookMobile2v192x300.png') }} 192w,
                          {{ url('assets/img/AppLookMobile2v383x600.png?width=383&height=600&name=AppLookMobile2v383x600.png') }} 383w,
                          {{ url('assets/img/AppLookMobile2v575x900.png?width=575&height=900&name=AppLookMobile2v575x900.png') }} 575w,
                          {{ url('assets/img/AppLookMobile2v766x1200.png?width=766&height=1200&name=AppLookMobile2v766x900.png') }} 766w,
                          {{ url('assets/img/AppLookMobile2v958x1500.png?width=958&height=1500&name=AppLookMobile2v958x1500.png') }} 958w,
                          {{ url('assets/img/AppLookMobile2v1149x1800.png?width=1149&height=1800&name=AppLookMobile2v1149x1800.png') }} 1149w" sizes="(max-width: 383px) 100vw, 383px">
                        </span>
                      </div>
                    </div>
                    <!--end widget-span -->
              ...
              <!--end widget-span -->
              <div class="span6 widget-span widget-type-cell cell_1660660286556-padding cell_1660660286556-vertical-alignment dnd-column aos-init" style="" data-widget-type="cell" data-x="6" data-w="6" data-aos="fade-up" data-aos-delay="200">
                <div class="row-fluid-wrapper row-depth-1 row-number-16 dnd-row">
                  <div class="row-fluid ">
                    <div class="span12 widget-span widget-type-custom_widget dnd-module" style="" data-widget-type="custom_widget" data-x="0" data-w="12">
                      <div id="hs_cos_wrapper_widget_1660660286232" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module widget-type-rich_text" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module">
                        <span id="hs_cos_wrapper_widget_1660660286232_" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_rich_text" style="" data-hs-cos-general-type="widget" data-hs-cos-type="rich_text">
                          <h2>All it takes is a <span style="color: #ffd61f;">smartphone</span>
                          </h2>
                          <p>Create your <span style="font-weight: bold; color: #ffd61f;">free inspector account in five minutes</span> or less and view requests for inspections within your region, on our easy to use platform. </p>
                          <p>Submit lumpsum offers including your rate and milleage.</p>
                          <ul>
                            <li>Get automated alerts when new requests are posted</li>
                            <li>Get paid upon completion of each job within minutes</li>
                            <li>Get rated by the customer and secure more jobs</li>
                          </ul>
                        </span>
                      </div>
                    </div>
            ...
            <div class="row-fluid ">
              <div class="span12 widget-span widget-type-cell cell_16602185125432-padding cell_16602185125432-margin dnd-column" style="" data-widget-type="cell" data-x="0" data-w="12">
                <div class="row-fluid-wrapper row-depth-1 row-number-18 dnd-row">
                  <div class="row-fluid ">
                    <div class="span6 widget-span widget-type-cell dnd-column aos-init" style="" data-widget-type="cell" data-x="0" data-w="6" data-aos="fade-up" data-aos-delay="0">
                      <div class="row-fluid-wrapper row-depth-1 row-number-19 dnd-row">
                        <div class="row-fluid ">
                          <div class="span12 widget-span widget-type-custom_widget dnd-module" style="" data-widget-type="custom_widget" data-x="0" data-w="12">
                            <div id="hs_cos_wrapper_widget_1660657308109" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module widget-type-rich_text" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module">
                              <span id="hs_cos_wrapper_widget_1660657308109_" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_rich_text" style="" data-hs-cos-general-type="widget" data-hs-cos-type="rich_text">
                                <h2>Our <span style="color: #ffd61f;">award-winning</span> platform </h2>
                                <p>Inspexion.com was <span style="font-weight: bold; color: #ffd61f;">awarded the first prize for the Tech4Good challenge</span> in 2022. </p>
                                <p>Inspexion.com has disrupted the inspection and certification industry by giving access to more jobs to more inspectors worldwide.</p>
                              </span>
                            </div>
                          </div>
                          <!--end widget-span -->
                    ...
                    <!--end widget-span -->
                    <div style="display:none;" class="span3 widget-span widget-type-cell dnd-column aos-init" style="" data-widget-type="cell" data-x="6" data-w="3" data-aos="fade-up" data-aos-delay="200">
                      <div class="row-fluid-wrapper row-depth-1 row-number-20 dnd-row">
                        <div class="row-fluid ">
                          <div class="span12 widget-span widget-type-custom_widget dnd-module" style="" data-widget-type="custom_widget" data-x="0" data-w="12">
                            <div id="hs_cos_wrapper_widget_1660657110652" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module">
                              <div class="counter--widget_1660657110652 text-left counter " id=""></div>
                            </div>
                          </div>
                          <!--end widget-span -->
                        </div>
                      ...
                      <div class="row-fluid-wrapper row-depth-1 row-number-21 dnd-row">
                        <div class="row-fluid ">
                          <div class="span12 widget-span widget-type-custom_widget dnd-module" style="" data-widget-type="custom_widget" data-x="0" data-w="12">
                            <div id="hs_cos_wrapper_module_1660657293800" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module">
                              <div class="counter--module_1660657293800 text-left counter " id=""></div>
                            </div>
                          </div>
                          <!--end widget-span -->
                        </div>
                    ...
                    <!--end widget-span -->
                    <div style="display:none;" class="span3 widget-span widget-type-cell dnd-column aos-init" style="" data-widget-type="cell" data-x="9" data-w="3" data-aos="fade-up" data-aos-delay="400">
                      <div class="row-fluid-wrapper row-depth-1 row-number-22 dnd-row">
                        <div class="row-fluid ">
                          <div class="span12 widget-span widget-type-custom_widget dnd-module" style="" data-widget-type="custom_widget" data-x="0" data-w="12">
                            <div id="hs_cos_wrapper_module_1660657172477" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module">
                              <div class="counter--module_1660657172477 text-left counter " id=""></div>
                            </div>
                          </div>
                          <!--end widget-span -->
                        </div>
                      ...
                      <div class="row-fluid-wrapper row-depth-1 row-number-23 dnd-row">
                        <div class="row-fluid ">
                          <div class="span12 widget-span widget-type-custom_widget dnd-module" style="" data-widget-type="custom_widget" data-x="0" data-w="12">
                            <div id="hs_cos_wrapper_module_1660657281995" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module">
                              <div class="counter--module_1660657281995 text-left counter " id=""></div>
                            </div>
                          </div>
                          <!--end widget-span -->
                        </div>
            ...
            <div class="row-fluid ">
              <div class="span12 widget-span widget-type-cell dnd-column" style="" data-widget-type="cell" data-x="0" data-w="12">
                <div class="row-fluid-wrapper row-depth-1 row-number-25 dnd-row">
                  <div class="row-fluid ">
                    <div class="span12 widget-span widget-type-custom_widget dnd-module" style="" data-widget-type="custom_widget" data-x="0" data-w="12">
                      <div id="hs_cos_wrapper_widget_1660658121417" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module">
                        <div class="main-cta flex-container  widget_1660658121417" id="">
                          <div class="main-cta__column-left-cta margin-0 widget_1660658121417">
                            <div class="main-cta__column-left-inner widget_1660658121417">
                              <h2>
                                <span style="color: #293182;">Are you an inspection company or a freelance quality professional?</span>
                              </h2>
                              <span id="hs_cos_wrapper_widget_1660658121417_" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_cta" style="" data-hs-cos-general-type="widget" data-hs-cos-type="cta">
                                <!--HubSpot Call-to-Action Code -->
                                <span class="hs-cta-wrapper" id="hs-cta-wrapper-8f656c48-262a-4b61-a7aa-fdaf8d3eaa66">
                                  <span class="hs-cta-node hs-cta-8f656c48-262a-4b61-a7aa-fdaf8d3eaa66" id="hs-cta-8f656c48-262a-4b61-a7aa-fdaf8d3eaa66">
                                    <!--[if lte IE 8]>
                                    ...
                                    <a href="javascript:void(0);" style="display:none;">
                                      <img class="hs-cta-img" id="hs-cta-img-8f656c48-262a-4b61-a7aa-fdaf8d3eaa66" style="border-width:0px;" src="" alt="Become an approved quality provider">
                                    </a>
                                  </span>
                                </span>
                                <!-- end HubSpot Call-to-Action Code -->
                          ...
                          <div class="main-cta__column-right margin-0 lazy widget_1660658121417 loaded" data-ll-status="loaded" style="background-image: url('<?php echo url('assets/img/gallery_small.jpeg'); ?>');"></div>
                        </div>
                      </div>
                    </div>
                    <!--end widget-span -->
          ...
          <!--end row-wrapper -->
          <div class="dnd_area-row-9-background-layers row-fluid-wrapper row-depth-1 row-number-29 dnd_area-row-7-background-layers dnd-section dnd_area-row-7-background-gradient dnd_area-row-7-padding">
            <div class="row-fluid ">
              <div class="span12 widget-span widget-type-cell dnd-column" style="" data-widget-type="cell" data-x="0" data-w="12">
                <div class="row-fluid-wrapper row-depth-1 row-number-30 dnd-row">
                  <div class="row-fluid "><div class="span12 widget-span widget-type-custom_widget dnd-module" style="" data-widget-type="custom_widget" data-x="0" data-w="12"><div id="hs_cos_wrapper_module_16611707535464" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module widget-type-rich_text" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module"><span id="hs_cos_wrapper_module_16611707535464_" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_rich_text" style="" data-hs-cos-general-type="widget" data-hs-cos-type="rich_text"><h2 style="text-align: center;"><span style="color: #ffffff;">Our partners</span></h2></span></div></div>
                    <!--end widget-span -->
                  </div>
                  <!--end row-->
                </div>
                ...
                <div class="row-fluid-wrapper row-depth-1 row-number-31 dnd-row">
                  <div class="row-fluid "><div class="span12 widget-span widget-type-custom_widget dnd-module" style="" data-widget-type="custom_widget" data-x="0" data-w="12"><div id="hs_cos_wrapper_module_16611707535465" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" style="" data-hs-cos-general-type="widget" data-hs-cos-type="module"><div class="logos-of-customers " id=""><div class="module_16611707535465-logo-1"><a href="javascript:void(0);" rel="noreferrer" target="_blank"><img class="lazy loaded" alt="InspeXion - partner of Fingertip" style="max-width: 100%; height: auto;" height="250" width="500" data-ll-status="loaded" src="{{url('assets/img/Fingertip.png'); }}"></a></div><div class="module_16611707535465-logo-2"><a href="javascript:void(0);" rel="noreferrer" target="_blank"><img class="lazy loaded" alt="InspeXion - partner of Workclout" style="max-width: 100%; height: auto;" height="250" width="500" data-ll-status="loaded" src="{{url('assets/img/WorkClout.png'); }}"></a></div><div class="module_16611707535465-logo-3"><a href="javascript:void(0);" rel="noreferrer" target="_blank"><img class="lazy loaded" alt="Prolognet" style="max-width: 100%; height: auto;" height="250" width="500" data-ll-status="loaded" src="{{url('assets/img/Prolognet.png'); }}"></a></div></div></div></div>
                    <!--end widget-span -->
                  </div>
                  <!--end row-->
                </div>
