    ...
    <table role="presentation" class="email-container">
        <tr>
            <td class="email-header">
                ...
                <p style="text-align:center;">Update on Your Application #{{$applicationId}} Status</p>
            </td>
        </tr>
        <tr>
            <td class="email-body">
                ...
                <p>
                We hope this message finds you well. We would like to inform you that the status of your application #{{$applicationId}} has been updated.
                </p>
                
                <p><strong>Current Status: </strong>{{$status}}</p>

                <p>
                We appreciate your interest in SmartKYC, and we will keep you informed of any further developments.

                If you have any questions or need assistance, feel free to contact us at <a href="mailto:support@smartkyc.ng">support@smartkyc.ng</a>.</p>
